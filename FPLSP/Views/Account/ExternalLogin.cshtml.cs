...
namespace FPLSP.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
            ...
            if (ModelState.IsValid)
            {
                ...
                if ((userWithexternalMail != null) && (Input.Email == externalMail))
                {
                    ...
                    else
                    {
                        ...
                        {
                            title = "LIÊN KẾT TÀI KHOẢN",
                            urlredirect = Url.Page($"/Login?returnUrl={returnUrl}"),
                ...
                var user = new UserSignIn { UserName = Input.Email, Email = Input.Email };
