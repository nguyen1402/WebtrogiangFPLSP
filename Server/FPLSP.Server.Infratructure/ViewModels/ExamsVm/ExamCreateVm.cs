...
{
    public class ExamCreateVm : IValidatableObject
    {
        [Required(ErrorMessage = "Không được bỏ trống Mã Đề Thi")]
        [RegularExpression(@"^[A-Z''-'\d/s/]{1,10}$", ErrorMessage = "Mã đề thi phải in hoa, không được có kí tự đặc biệt, tối đa 10 kí tự")]
