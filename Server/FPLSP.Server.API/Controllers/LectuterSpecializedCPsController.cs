...
namespace FPLSP.Server.API.Controllers
{
    ...
    [ApiController]
    public class LectuterSpecializedCPsController : ControllerBase
    {
        private readonly ILectuterSpecializedCPServices _repo;
        public LectuterSpecializedCPsController(ILectuterSpecializedCPServices repo)
        {
            _repo = repo;
        }
