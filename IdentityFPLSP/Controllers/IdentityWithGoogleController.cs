using IdentityFPLSP.ViewModels;
...
namespace IdentityFPLSP.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class IdentityWithGoogleController : ControllerBase
    {
        ...
        //public IdentityWithGoogleController(SignInManager<AppUser> signInManager, UserManager<AppUser> userManager, IEmailSender emailSender)
        //{
        ...
        //    {
        //        RedirectUri = "https:localhost6001/adminlogin",
        ...
        //[HttpPost]
        //[Route("Post-Service")]
        //public async Task<IActionResult> PostService(string provider, string returnUrl = null)
        //{
        ...
        //    var redirectUrl = Url.Page("./AdminLogin", pageHandler: "Callback", values: new { returnUrl });
        ...
        //}
        //[HttpPost]
        //[Route("OnGetCallbackAsync")]
        //public async Task<IActionResult> OnGetCallbackAsync([FromBody] OnGetCallbackAsync onGetCallbackAsync)
        //{
        //    onGetCallbackAsync.ReturnUrl = onGetCallbackAsync.ReturnUrl ?? Url.Content("~/");
        //    if (onGetCallbackAsync.RemoteError != null)
        //    {

        //        return RedirectToPage("./Login", new { ReturnUrl = onGetCallbackAsync.ReturnUrl });
        //    }
        ...
        //        return LocalRedirect(onGetCallbackAsync.ReturnUrl);
        //    }
        ...
        //        ReturnUrl = onGetCallbackAsync.ReturnUrl;
